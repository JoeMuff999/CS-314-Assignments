...
public class MathMatrix
{
	 ...
	 * 
	 * @param mat
	 *            mat !=null, mat.length > 0, mat[0].length > 0, mat is a
	 *            rectangular matrix
	 */
	 ...
	 * 
	 * @param rightHandSide
	 *            rightHandSide.getNumRows() = getNumRows(), rightHandSide.numCols()
	 *            = getNumColumns()
	 ...
	 * 
	 * @param factor
	 *            the value to multiply every cell in this Matrix by.
