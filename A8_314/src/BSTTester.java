...
public class BSTTester {
    ...
    public static void main(String[] args) {
        ...
        t.printTree();
        System.out.println(t.numNodesAtDepth(3));
        System.out.println(t.numNodesAtDepth(2));
        System.out.println(t.numNodesAtDepth(1));
        System.out.println(t.numNodesAtDepth(6));
        //test 18
